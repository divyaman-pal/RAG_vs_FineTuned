...
# python3 finetuned_enron_ppl.py --input_file question_ppl_email.json --output_file Target_Email_Address_output_ppl.json --perplexity_file Target_Email_Address_perplexities.json


# nohup python3 finetuned_enron_ppl.py --input_file question_ppl_email.json --output_file Target_Email_Address_output_ppl.json --perplexity_file Target_Email_Address_perplexities.json > output_enron.log 2>&1 &
